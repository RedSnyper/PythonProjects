...
import math
print(' IF THIS PROGRAM THROWS ERROR TRY THE ANOTHER (NO INTEGER ROOT) PROGRAM WHERE YOU EXPLICITLY PUT THE FIRST A AND B KO VALUE - ')
print('here the first tabulation is presented to you')
